...
def student_dashboard():
  ...
  if not student_data:
    # Safety net: if we ever land here without student_data, bounce back to login
  ...
  for i, sub_node in enumerate(subjects):
    ...
    with cols[i % 2]:
      subject_card(
        ...
        # Confirmed: Supabase column is 'section', not 'selection'
...
def student_screen():
  ...
  # text_alignment isn't a supported kwarg on st.header in this Streamlit
  # version — removed to avoid a TypeError. Use markdown/CSS if you need
  # centered text.
      ...
      if num_faces == 0:
        ...
        if detected:
          ...
          if student:
            ...
            st.warning('Matched a face but could not find the student record.')
        else:
